...
## Restoration Economy
Declines in extractive industries such as mining, logging, and cattle grazing in the West have had devastating impacts on rural communities {cite}`davis`, {cite}`formosa`, {cite}`hibbard`. At the same time, it has created informal (cannabis) and formal (restoration) economies that have brought new opportunities and funding while restoring ecosystem function {cite}`kelly`. {cite:t}`bendor` found that more people were employed in restoration in the US than coal mining, logging, and steel manufacturing. However, benefits of the restoration economy and economic development are often scattered or only developed in places with access to capital or higher capacity nonprofits. How can this development be more equitable, especially in the areas where wildfires threaten economic and ecosystem health?
