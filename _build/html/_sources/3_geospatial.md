...
## Overview
California recognizes the importance of agency and business focus on forest health and treatment. Workforce and business development are key parts of the State’s efforts to improve forest health, largely to reduce wildfire risk and damage. This analysis focuses on Yuba County as a case study in statewide efforts to establish a forest-focused industry to treat forests and address wildfire risk to communities, the infrastructure they rely on, and surrounding forests.
...
Local officials, agencies, and communities want to improve forest conditions, but they face barriers. Mitigating more damaging wildfires is a priority for the County, communities, Yuba Watershed Protection and Firesafe Council, and Yuba County Water Agency.
...
Generally, the risk for any analyses increased when moving from lower to higher elevations and agricultural to forested systems. This is unsurprising since we relied on datasets that focused on fire, forest, and topography. The analysis presented important consideration for the communities in the extreme northeast of the county, such as Camptonville, Dobbins, and Brownsville. Other datasets are cited in each section or within each figure below in the text.
## Egress Risk
...
:height: 400px
:name: nbb
A closer look at the New Bullards Bar Reservoir reveals low-risk areas nearshore and high-risk areas north and south of the dam.
```
